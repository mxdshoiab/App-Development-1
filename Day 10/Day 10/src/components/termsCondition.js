...
import '../components/termsCondition.css';
              ...
              <div className="col-sm-8 col-sm-offset-2">
                ...
                <div className="terms-body">
                  ...
                  <p>
                    ...
                    {/* FOOTER */}  
                  </p><div className="container terms_footer"> <h3>Can't find what you're looking for? <a href="www.themainalabel.com">Email us</a></h3>
                  </div>   
                </div>   
              </div>
            </div>
